...
const RegistrationForm = ({ setRegistrationForm }) => {
  ...
  return (
<section className="fixed inset-0 z-50 w-full bg-[#040207] text-white overflow-y-auto flex items-start justify-center p-3 md:p-6 lg:p-12">
      ...
      <div className="relative w-full max-w-[1280px] mx-auto z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center py-6">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center h-full space-y-6 text-center lg:text-left px-2">
          ...
          <div className="relative w-[190px] sm:w-[260px] lg:w-[320px] aspect-square mx-auto lg:mx-0 flex items-center justify-center group mt-4">
            ...
            <div className="absolute inset-[-10px] border border-cyan-500/50 rounded-full animate-[spin_20s_linear_infinite]" />
            <div className="absolute inset-[-20px] border border-dashed border-pink-500/70 rounded-full animate-[spin_35s_linear_infinite_reverse]" />
            <div className="absolute inset-[20px] border border-cyan-500/50 rounded-full animate-[spin_20s_linear_infinite]" />
            <div className="absolute inset-[10px] border border-dashed border-pink-500/70 rounded-full animate-[spin_35s_linear_infinite_reverse]" />
